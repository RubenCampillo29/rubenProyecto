  ...
  <div class="container py-4">
    ...
    <div class="mb-3 row">
       <label for="poblacion" class="col-sm-2 col-form-label"><strong>Poblacion</strong></label>
        <div class="col-sm-5">
          <input type="text" class="form-control" name="poblacion" id="poblacion" value="{{ $cliente->poblacion }}" >
        </div>      
    </div>
    ...
    <div class="mb-3 row">
       <label for="CodigoPostal" class="col-sm-2 col-form-label"><strong>Codigo Postal</strong></label>
        <div class="col-sm-5">
          <input type="number" class="form-control" name="CodigoPostal" id="CodigoPostal" value="{{ $cliente->CodigoPostal }}" >
        </div>      
    </div>
