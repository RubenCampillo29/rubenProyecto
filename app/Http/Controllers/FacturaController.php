...
class FacturaController extends Controller
{
    ...
    public function enviar(){
        ...
        $clientfile=getcwd().file_get_contents(app_path('Http\Controllers\certificado.pem'));; // el archivo de certificado en formato .pem (para tu Apache). Ojo a los slash... es una ruta... y hay quien se los come y dice que no le funciona
        
        $keyfile=getcwd().file_get_contents(app_path('Http\Controllers\certificado_key.pem')); //el archivo que contiene la clave privada para autenticarte.
